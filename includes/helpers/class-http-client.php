...
class HttpClient {
	 ...
	 * Send GET request.
	 */
	public static function get( string $url, array $args = array(), array $headers = array() ): array|\WP_Error {
		$defaults = array(
	 ...
	 */
	public static function post( string $url, array $data = array(), array $args = array() ): array|\WP_Error {
		$defaults = array(
			'method'  => 'POST',
			'timeout' => self::TIMEOUT,
			'headers' => array(
